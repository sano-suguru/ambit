 ...
 * of widely-used third-party packages (both are legitimate sources of effect
 * evidence — the same table, not a separate one).
 ...
 *
 * `docs/diagnostics/` and DESIGN.md track stub trust levels; this table
